...
<body>
					...
					<li class="btn-desplegable">
						...
						<div class="btn-navbar-content">
							...
							<a href="detalleJuguete.jsp">Juguetes</a> <a
								href="detalle-otros.jsp">Otros</a> <a href="ver-todos.jsp">Todos</a>
						</div>
					</li>
	...
	<script>
        ...
        function addProductRow(product) {
            ...
            newRow.insertCell(6).textContent = product.isOrganic === 'res' ? 'Sí' : 'No';
        ...
        function deleteProduct(productId) {
            ...
            updatedProducts.forEach(product => addProductRow(product));
        }
    </script>
</body>
</html>