...
<div class="container py-0">
	<div class="row py-0">
		<div class="col-lg-5 m-auto text-center">
			<h3>Increible Variedad de Frutas</h3>
		</div>
	</div>
	<div class="row row-cols-sm1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3">
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				<h5 class="card-title pt-2 text-center">Manzana</h5>
				<img src="Sources/manzana.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<p class="card-text description">Crujiente y jugosa, perfecta
						como snack o en postres. ¡Llena de frescura y sabor!</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				<h5 class="card-title pt-2 text-center">Mango</h5>
				<img src="Sources/mango.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<p class="card-text description">Dulce y tropical, ideal para
						ensaladas, batidos o como postre refrescante.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				<h5 class="card-title pt-2 text-center">Fresa</h5>
				<img src="Sources/fresas.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<p class="card-text description">Jugosa y vibrante, perfecta
						para postres, batidos o disfrutar sola.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				<h5 class="card-title pt-2 text-center">Pera</h5>
				<img src="Sources/pera.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<p class="card-text description">Suave y dulce, deliciosa en
						ensaladas, postres o como snack saludable.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				<h5 class="card-title pt-2 text-center">Banano</h5>
				<img src="Sources/banano.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<p class="card-text description">Nutritivo y energético,
						perfecto para comer solo, en batidos o postres.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				<h5 class="card-title pt-2 text-center">Papaya</h5>
				<img src="Sources/papaya.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<p class="card-text description">Dulce y refrescante, rica en
						vitaminas, ideal para desayunos y batidos</p>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="row">
					<div class="col-lg-3 py-3">
						...
						<a style="color: white;" href="index.html" id="Inicio">Inicio
							<br>
						</a> <a style="color: white;" href="login.html" id="Inicio">Iniciar
							sesión</a>
