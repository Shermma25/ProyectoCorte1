...
<body>
    ...
    <div class="container">
        <h1 class="mt-5">Productos Registrados Otros</h1>
        ...
        <a href="crear-otros.jsp" class="btn back-button mt-3">Volver al Registro de Productos</a>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            products
                .filter(product => product.category === 'otros') // Filtra por categoría
                .forEach(product => {
        ...
        function addProductRow(product) {
            ...
            newRow.insertCell(3).textContent = product.description; // Nueva celda para Descripción
            ...
            const actionsCell = newRow.insertCell(6); // Columna 6 para acciones
        ...
        function deleteProduct(productId) {
            ...
            updatedProducts
                .filter(product => product.category === 'otros') // Refiltro después de eliminar
