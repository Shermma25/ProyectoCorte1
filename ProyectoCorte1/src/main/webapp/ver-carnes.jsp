...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            products
                .filter(product => product.category === 'carnes') // Filtra por categoría
                .forEach(product => {
        ...
        function addProductRow(product) {
            ...
            newRow.insertCell(3).textContent = getAnimalOrigin(product.animalOrigin); // Nueva celda para Animal de Origen
            newRow.insertCell(4).textContent = product.expirationDate;
            newRow.insertCell(5).textContent = product.harvestDate;
            newRow.insertCell(6).textContent = product.units;
            newRow.insertCell(7).textContent = product.isOrganic === 'res' ? 'Sí' : 'No';

            // Crear la columna de acciones
            const actionsCell = newRow.insertCell(8); // Columna 8 para acciones
        ...
        function getAnimalOrigin(value) {
            const origins = {
                res: 'Res',
                cerdo: 'Cerdo',
                pollo: 'Pollo',
            ...
            return origins[value] || 'Desconocido';
        }
        ...
        function deleteProduct(productId) {
            ...
            updatedProducts
                .filter(product => product.category === 'carnes') // Refiltro después de eliminar
