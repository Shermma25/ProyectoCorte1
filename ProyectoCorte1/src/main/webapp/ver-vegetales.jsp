...
<body>
	...
	<div class="container">
		<h1 class="mt-5">Productos Registrados Vegetales</h1>
		...
		<a href="crear-vegetales.jsp" class="btn back-button mt-3">Volver
			al Registro de Productos</a>
	</div>
	...
	<script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            products
                .filter(product => product.category === 'vegetales') // Filtra por categoría de vegetales
                .forEach(product => {
        ...
        function addProductRow(product) {
            ...
            newRow.insertCell(3).textContent = product.isOrganic === 'si' ? 'Sí' : 'No'; // Corregido a 'si'
        ...
        function deleteProduct(productId) {
            ...
            updatedProducts
                .filter(product => product.category === 'vegetales') // Refiltro después de eliminar
