	...
	<div class="row row-cols-sm1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3">
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				...
				<div class="card-body">
					<p class="card-text description">Jugosa y llena de sabor, ideal
						para asados, guisos o cualquier plato principal.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				...
				<div class="card-body">
					<p class="card-text description">Tierna y versátil, perfecta
						para asados, estofados o platos tradicionales.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				...
				<div class="card-body">
					<p class="card-text description">Delicado y nutritivo, ideal
						para cualquier receta, desde ensaladas hasta platos al horno.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				...
				<div class="card-body">
					<p class="card-text description">Fresco y ligero, lleno de
						proteínas y omega-3. Perfecto para platos saludables y deliciosos.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				...
				<div class="card-body">
					<p class="card-text description">Delicados y llenos de sabor,
						ideales para paellas, sopas o como aperitivos.</p>
				</div>
			</div>
		</div>
		<div class="col d-flex justyfy-content-center mb-4">
			<div class="card border-0 bg-light-mb-2" style="width: 45rem;">
				...
				<div class="card-body">
					<p class="card-text description">Magro y sabroso, perfecto para
						asados y recetas saludables. Una excelente opción para cualquier
						ocasión</p>
				</div>
			</div>
		</div>
