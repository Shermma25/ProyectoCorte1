...
<body>
	...
	<div class="container">
		<h1 class="mt-5">Productos Registrados Juguetes</h1>
		...
		<a href="crear-juguetes.jsp" class="btn back-button mt-3">Volver
	...
	<script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            products
                .filter(product => product.category === 'juguetes') // Filtra por categoría
                .forEach(product => {
        ...
        function addProductRow(product) {
            ...
            newRow.insertCell(3).textContent = product.lotNumber; // Número de Lote
            newRow.insertCell(4).textContent = product.units;
            newRow.insertCell(5).textContent = product.minAge;
            newRow.insertCell(6).textContent = product.numPlayers;
        ...
        function deleteProduct(productId) {
            ...
            updatedProducts
                .filter(product => product.category === 'juguetes') // Refiltro después de eliminar
